...
3. Подключить ESP32S3 к USBUART
4. 
   Собрать проект
   Выбрать COM-Port
...
1. Подключите USB-OTG ESP32-S3 к компьютеру 
2. Подключить шифтер к CANtransiver А так же  CANlow CANHigh Трансивера к линии PT-CAN1 шифтера.
...
Уточнения и Картинки будут немного позже . 
